...
@app.route("/melon/<int:melon_id>") # this is where the variable is passed from all_melons
def show_melon(melon_id):
# def show_melon(melon_int):
    ...
    # melon = melons.get_by_id(melon_int)
    print melon
...
def shopping_cart():
    ...
    # check that our session was succesfully created
    # session[2]= "hello"
    # print session
